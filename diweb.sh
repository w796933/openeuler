...
## GPL,Written By MoeClub.org and linux-live.org,moded by minlearn (https://gitee.com/minlearn/minstack/) for openeuler remastering and installing (both local install and cloud dd) purposes and for onedrive mirror/image hosting.
## meant to work/tested under linux and osx with bash > 4
## usage: ci.sh [[-b 0 ] -h 0] -t openeuler|debianbase
## usage: diweb.sh -t openeuler|deepin20|win10ltsc|winsrv2019|dsm61715284|osx10146
...
export tmpTARGET='' #debianbase(none),openeuler,winsrvcore2019,deepin20,dsm61715284,osx10146
